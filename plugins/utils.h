...
#define UT_EXTRA_OPTS _("\
 --extra-opts=[section][@file]\n\
    Read options from an ini file. See http://monitoringplugins.org/extra-opts\n\
...
#define UT_THRESHOLDS_NOTES _("\
 See:\n\
 http://monitoringplug.sourceforge.net/developer-guidelines.html#THRESHOLDFORMAT\n\
 for THRESHOLD format and examples.\n")

#define UT_SUPPORT _("\n\
Send email to monitoring-users@lists.sourceforge.net if you have questions\n\
regarding use of this software. To submit patches or suggest improvements,\n\
send email to monitoringplug-devel@lists.sourceforge.net\n\n")
